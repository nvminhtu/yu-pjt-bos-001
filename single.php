  ...
  <div class="inner clearfix">
    <div class="left_content">
      ...
      <div class="blogdetail_date clearfix">
        <p class="date"><span class="cal">2016.12.03</span></p>
        <!-- <div class="social01"><img src="<?php bloginfo('template_url'); ?>/images/bloglist/bloglist_detail_social01.jpg" /></div> -->
        <div id="social-button1"></div>
      </div>
      <h2 class="style_h2">h2 が入ります。 h2 が入ります。h2 が入ります。h2 が入ります。h2 が入ります。h2 が入ります。</h2>
      <div class="c_section">
