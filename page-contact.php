...
<style>
	/*#contact .inner{width: 1240px;}
	#contact .menu-top-menu-container ul{margin-bottom:1px;}
	#contact #submitconfirm{background: url(<?php bloginfo('template_url') ; ?>/images/contact/btn_01.png); width: 335px;
